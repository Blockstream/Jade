...
typedef enum {
    ...
    BTN_SETTINGS_USB_STORAGE,
    BTN_SETTINGS_USB_STORAGE_FW,
    BTN_SETTINGS_USB_STORAGE_FW_BACK,
    BTN_SETTINGS_USB_STORAGE_FW_HELP,
    BTN_SETTINGS_USB_STORAGE_SIGN,
    BTN_SETTINGS_USB_STORAGE_EXPORT,
    BTN_SETTINGS_USB_STORAGE_EXIT,
    BTN_SETTINGS_USB_STORAGE_FW_EXIT,
#endif
    BTN_SETTINGS_BLE,
