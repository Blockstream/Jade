    ...
    gui_activity_t** actscript2, gui_activity_t** actscript3)
{
    ...
    *actname = make_show_single_value_activity("Wallet Name", descriptor_name, show_help_btn);
    ...
    if (descriptor->script_len > (2 * sizeof(descriptor->script) / 3)) {
        ...
        *actscript1 = make_show_message_activity(display_str, 8, "Script (1/3)", hdrbtns, 2, NULL, 0);
        ...
        JADE_ASSERT(ret > 0 && ret < sizeof(display_str));
        *actscript2 = make_show_message_activity(display_str, 8, "Script (2/3)", hdrbtns, 2, NULL, 0);
        ...
        JADE_ASSERT(ret > 0 && ret < sizeof(display_str));
        *actscript3 = make_show_message_activity(display_str, 8, "Script (3/3)", hdrbtns, 2, NULL, 0);
        ...
        int ret = snprintf(display_str, sizeof(display_str), "%.*s", display_len, descriptor->script);
        JADE_ASSERT(ret > 0 && ret < sizeof(display_str));
        *actscript1 = make_show_message_activity(display_str, 8, "Script (1/2)", hdrbtns, 2, NULL, 0);
        ...
        JADE_ASSERT(ret > 0 && ret < sizeof(display_str));
        *actscript2 = make_show_message_activity(display_str, 8, "Script (2/2)", hdrbtns, 2, NULL, 0);
