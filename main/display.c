...
static void display_draw_touch_buttons(void)
{
    ...
    dispWin_t disp_win_virtual_buttons = { .x1 = TOUCH_BUTTON_PADDING + CONFIG_DISPLAY_OFFSET_X,
        .y1 = CONFIG_DISPLAY_HEIGHT + TOUCH_BUTTON_PADDING + CONFIG_DISPLAY_OFFSET_Y,
        .x2 = TOUCH_BUTTON_WIDTH + CONFIG_DISPLAY_OFFSET_X,
        .y2 = (CONFIG_DISPLAY_HEIGHT + (TOUCH_BUTTON_HEIGHT - TOUCH_BUTTON_PADDING)) + CONFIG_DISPLAY_OFFSET_Y };
    ...
    disp_win_virtual_buttons.x1
        = ((CONFIG_DISPLAY_WIDTH - TOUCH_BUTTON_PADDING) + CONFIG_DISPLAY_OFFSET_X) - TOUCH_BUTTON_WIDTH;
    disp_win_virtual_buttons.x2 = (CONFIG_DISPLAY_WIDTH - TOUCH_BUTTON_PADDING) + CONFIG_DISPLAY_OFFSET_X;
